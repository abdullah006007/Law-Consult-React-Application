        ...
        <div>
            ...
            {displayData.length === 0 ? (
                <div className="text-center mt-8">
                   ...
                   <Link to="/" > <button className='bg-[#0EA106] btn text-white cursor-pointer py-1 px-5 rounded-4xl'>Book an Appointment</button></Link>
                </div>
            ) : (
                <>
                    <RChart displayData={displayData}></RChart>
                    ...
                    <div className=''>
                        {
                            displayData.map(person => <BookingDeatils person={person} handleCancel={handleCancel}></BookingDeatils>)
                        }
                    </div>
